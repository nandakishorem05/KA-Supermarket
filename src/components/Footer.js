    ...
    <footer style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 22 }}>
              <div style={{
                ...
                boxShadow: '0 4px 20px rgba(245,158,11,0.2)', flexShrink: 0,
              }}>
                <Image src="/ka-logo.jpeg" alt="KA Supermarket" width={54} height={54}
              ...
              <div>
                ...
                <div style={{ fontFamily: "'Outfit', sans-serif", fontSize: 10, fontWeight: 700, color: 'var(--amber-light)', letterSpacing: 1.5, textTransform: 'uppercase', marginTop: 3 }}>
                  Malabar&apos;s Finest
                </div>
              </div>
            </div>
            ...
            <p style={{
              ...
              fontSize: 14, color: 'rgba(255,251,245,0.5)',
            ...
            onMouseEnter={e => { e.currentTarget.style.background = 'rgba(245,158,11,0.22)'; e.currentTarget.style.borderColor = 'rgba(245,158,11,0.6)' }}
            onMouseLeave={e => { e.currentTarget.style.background = 'rgba(245,158,11,0.12)'; e.currentTarget.style.borderColor = 'rgba(245,158,11,0.3)' }}>
              ...
              <span style={{ fontFamily: "'Outfit', sans-serif", fontSize: 13, fontWeight: 700, color: 'var(--amber-light)' }}>
                +91 75949 69999
              </span>
            </a>
          </div>
          ...
          {/* Quick Links */}
          <div>
            <h4 style={{ fontFamily: "'Outfit', sans-serif", fontSize: 11, fontWeight: 800, color: 'rgba(253,230,138,0.4)', letterSpacing: 3, textTransform: 'uppercase', marginBottom: 24 }}>
              Quick Links
            </h4>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
              {quickLinks.map(link => (
                ...
                onMouseEnter={e => { e.currentTarget.style.color = 'var(--amber-light)'; e.currentTarget.querySelector('span').style.background = 'var(--amber)' }}
                onMouseLeave={e => { e.currentTarget.style.color = 'rgba(255,251,245,0.55)'; e.currentTarget.querySelector('span').style.background = 'rgba(245,158,11,0.3)' }}>
                  <span style={{ width: 6, height: 6, borderRadius: '50%', background: 'rgba(245,158,11,0.3)', flexShrink: 0, transition: 'background 0.2s' }} />
                  {link.label}
                </a>
              ))}
            </div>
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              {branches.map(branch => (
                ...
                onMouseLeave={e => e.currentTarget.style.color = 'rgba(255,251,245,0.55)'}>
          ...
          <div>
            ...
            <p style={{ fontFamily: "'Inter', sans-serif", fontSize: 14, color: 'rgba(255,251,245,0.5)', lineHeight: 1.75, fontWeight: 300, marginBottom: 22 }}>
        ...
        <div style={{
          ...
          <p style={{ fontFamily: "'Inter', sans-serif", fontSize: 13, color: 'rgba(255,251,245,0.28)', fontWeight: 300 }}>
            © {new Date().getFullYear()} KA Supermarket. All rights reserved.
          </p>
          <p style={{ fontFamily: "'Inter', sans-serif", fontSize: 12, color: 'rgba(255,251,245,0.2)', fontWeight: 300 }}>
